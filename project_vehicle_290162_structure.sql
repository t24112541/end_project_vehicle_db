...
CREATE TABLE `pk_comment` (
  ...
  `co_co_u_id` int(10) DEFAULT NULL,
  `co_co_u_table` text COLLATE utf8mb4_unicode_ci,
  `co_u_id` int(10) DEFAULT NULL,
  `co_u_table` text COLLATE utf8mb4_unicode_ci,
